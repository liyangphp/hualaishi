...
Page({
  ...
  data: {
    ...
    selectedShopId: wx.getStorageSync('shop').id, // 选择的自提门店id
    linkman: 'liyang', // 自提联系人
    phone: '15012487405', // 自提联系电话
  ...
  onShow() {
    ...
    _this.setData({
      selectedShopId: wx.getStorageSync('shop').shop_id,
      curDelivery:20
    })
    // 获取当前订单信息
    _this.getOrderData();
  ...
  onSelectExtractPoint() {
    let _this = this,
      ...
      wx.navigateTo({
        url: '../../shop-list/shop-list?page=pink'
      });
  },
        ...
        App.wxPayment({
          ...
          success: res => {
            App._get('sharing.order/detail', {
              ...
              wx.navigateTo({
                url: '../active/index?active_id=' + result.data.order.active_id,
              })
            });
          },
          fail: res => {
